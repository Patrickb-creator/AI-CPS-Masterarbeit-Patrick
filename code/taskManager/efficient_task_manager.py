    ...
    try:
        with open(task_file, 'r', encoding='utf-8') as file:
            with task_lock:
                ...
                # Clustern der Aufgaben
                for task in task_list:
                    if "apply" in task:
                        task_types["apply"].append(task)
                    elif "create" in task:
                        task_types["create"].append(task)
                    elif "refine" in task:
                        task_types["refine"].append(task)
...
# taks der taskliste hier gleich zusammenführen und als einen an den receiver senden der drin steht
