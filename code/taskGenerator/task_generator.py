...
def main():
    ...
    # get broker ip and connect to broker
    ...
    while True:
        try:
            ...
            task_generator(number_of_tasks=number_of_tasks, MQTT_topic="mqttTester", sender=sender, receiver=receiver, client=client, host=broker_ip)
        except ValueError:
