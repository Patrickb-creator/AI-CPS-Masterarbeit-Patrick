...
# Add the parent directory (where "taskGenerator" is) to the Python path so it finds the modules
...
def task_generator(number_of_tasks, task_type, MQTT_topic, client, host, MQTT_Username="user1", MQTT_Password="WhHe1NPfDBJ%"):
